...
<html>
    <head>
        <title>Private Games Brasil</title>
                ...
                <div class="full-wrapper relative clearfix">
                    ...
                    <div class="inner-nav desktop-nav">
                        <ul class="clearlist scroll-nav local-scroll">
                            ...
                            <li><a href="#services">Lineage II</a></li>
                            <li><a href="#portfolio">Ragnarok</a></li>
                            <?php  session_start();
                                        if (!isset($_SESSION['login']))
                                            {?>
                            <li>
                                <a href="#" class="mn-has-sub" style="height: 75px; line-height: 75px;">Entrar / Cadastrar <i class="fa fa-angle-down"></i></a>
                                
                                <ul class="mn-sub" style="display: none;">
                                    <form action="#">
                                        <li><input name="login" id="login"></input></li>
                                        <li><input name="pass" id="pass"></input></li>
                            ...
                            <?php }else {?>
                            <li><a href="#news">Painel de controle</a></li>
                            <?php } ?>
