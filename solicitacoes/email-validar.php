<?php
$x='<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head>
    <!--[if gte mso 9]><xml>
...
<body class="clean-body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #FFFFFF">
  ...
  <table class="nl-container" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #FFFFFF;width: 100%" cellpadding="0" cellspacing="0">
	...
	<div style="color:#555555;line-height:120%;font-family:'."Open Sans".', Helvetica, Arial, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 40px; padding-bottom: 10px;">	
		<div style="font-size:12px;line-height:14px;color:#555555;font-family:'."Open Sans".', Helvetica, Arial, sans-serif;text-align:left;"><p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center"><span style="font-size: 46px; line-height: 55px; color: rgb(255, 255, 255);">Private Games Brasil</span></p><p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center"><span style="font-size: 46px; line-height: 55px; color: rgb(255, 255, 255);">Lhe da as boas vindas</span></p></div>	
	</div>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="divider " style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
	...
	<div style="color:#134C75;font-family:"Bitter", Georgia, Times, "Times New Roman", serif;line-height:120%; padding-right: 30px; padding-left: 30px; padding-top: 30px; padding-bottom: 5px;">	
		<div style="font-size:12px;line-height:14px;font-family:Bitter, Georgia, Times, "Times New Roman", serif;color:#134C75;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"><span style="font-size: 24px; line-height: 28px;"><strong>Falta pouco</strong></span></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
	...
	<div style="color:#7E7E7E;font-family:'."Open Sans".', Helvetica, Arial, sans-serif;line-height:150%; padding-right: 30px; padding-left: 30px; padding-top: 5px; padding-bottom: 20px;">	
		<div style="font-size:12px;line-height:18px;color:#7E7E7E;font-family:'."Open Sans".', Helvetica, Arial, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Olá é muito bom ter você conosco '.$this->$nome.', esperamos fazer cada momento seu o mais incrível e divertido possível.</p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Para você fazer parte da nossa família falta apenas um passo, clica nesse botão e confirmar sua conta.</p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">'.$this->$nome.', obrigado por estar conosco hoje, obrigado por escolher nós e confiar sua diversão a Private Games Brasil.</p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">'.$this->$nome.', hoje é um grande dia para nós por ter você aqui.</p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<div align="center" class="button-container center " style="padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;">
  <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href=""LINKDEVALIDAÇÂO"" style="height:31pt; v-text-anchor:middle; width:108pt;" arcsize="58%" strokecolor="#49a6e8" fillcolor="#49a6e8"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:'."Open Sans".', Helvetica, Arial, sans-serif; font-size:16px;"><![endif]-->
    <a href="'.$this->$link."?login=".$login."&code=".$this->$code.'" target="_blank" style="display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #49a6e8; border-radius: 24px; -webkit-border-radius: 24px; -moz-border-radius: 24px; max-width: 145px; width: 95px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 25px; padding-bottom: 5px; padding-left: 25px; font-family: '."Open Sans".', Helvetica, Arial, sans-serif;mso-border-alt: none">
      <span style="font-family:'."Open Sans".', Helvetica, Arial, sans-serif;font-size:16px;line-height:32px;"><span style="font-size: 14px;">Validar e-mail</span></span>
    </a>
...
<!--[if mso]></td></tr></table><![endif]-->
	...
	<div style="color:#8F8F8F;font-family:'."Open Sans".', Helvetica, Arial, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">	
		<div style="line-height:14px;font-size:12px;color:#8F8F8F;font-family:'."Open Sans".', Helvetica, Arial, sans-serif;text-align:left;"><p style="margin: 0;line-height: 14px;font-size: 12px"><span style="font-size: 11px; line-height: 13px;">Copyright © 2018 Private Games Brasil, Todos os direitos reservados. </span><br><span style="font-size: 11px; line-height: 13px;">Você está recebendo este e-mail porque você se inscreveu&#160; em http://pgbrasil.com, se você não se inscreveu em nosso site por favor desconsidere</span><br><br></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
